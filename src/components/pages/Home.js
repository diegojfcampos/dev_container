  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles.centralBanners}>
        ...
        <img src="/html5-and-css3-banner.png" alt="logo HTMl and CSS" className={styles.img}></img>        
      </section>
      ...
      <article className={styles.htmlContent}>
        <img src="/logohtml.png" alt="Logo" height="250px"
      ...
      <article className={styles.centralBanners}>       
        ...
        <img id="imgTec" src="semantic.jpg" alt="ilustration html semantic" width="642" height="321" className={styles.img}></img>
